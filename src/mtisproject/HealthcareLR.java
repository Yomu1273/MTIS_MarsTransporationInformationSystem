 ...
 * @author YOGESH
 */
public class HealthcareLR extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(0, 0, 637, 60);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel3.setText("Login to make the transportation of health care facilities possible");
        ...
        jToggleButton2.setBounds(150, 210, 110, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel6.setText("...");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(10, 280, 330, 30);
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        for(int i=0;i<m.i4;i++)
        {
            if(m.arr4[i].username.equalsIgnoreCase(username))
            {
                ...
                {
                    m.s4.push(m.arr4[i]);
                    HealthcareMain hm = new HealthcareMain();
                    hm.setVisible(true);
                    this.setVisible(false);
                }
                else
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HealthcareLR().setVisible(true);
            }
        });
    }
