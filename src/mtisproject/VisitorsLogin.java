 ...
 * @author YOGESH
 */
public class VisitorsLogin extends javax.swing.JFrame {

    String username,password;
    public VisitorsLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jToggleButton2.setBounds(180, 210, 130, 30);

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel5.setText("....");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(20, 290, 210, 20);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisitorsLogin().setVisible(true);
            }
        });
    }
